    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-wrap">
                ...
                <basket-component :temp="{{json_encode('basket')}}" v-bind:locale="{{json_encode(strtolower(__('main.current_lang')))}}" v-bind:basket="{{isset($order->products) ? json_encode($order->getOrderArray()) : json_encode([])}}"></basket-component>
